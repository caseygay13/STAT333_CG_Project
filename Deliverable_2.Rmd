...
model_comparison <- data.frame(
  Model = c("Full Model", "Reduced Model", "Alternative Model", "Stepwise Model", "Literature Model"),
...
caption_text <- paste("This graphic shows the correlation coefficient between each respective variable and PTS.",
"We elected to remove FG, FGA, FG_PCT, AST, X2P, X2PA, X2P_PCT, X3P, X3PA, X3P_PCT, FT, FTA, FT_PCT, BLK, and DRB.",
"These variables were highly correlated with PTS, and their explanatory power toward WIN_PCT was not great enough to keep them in the model.",
"We kept ORB, STL, PF, and TOV, none of which had significant correlation with PTS.",
"We also elected to keep TRB, which was a bit more correlated with PTS, but was found to be a significant explainer of WIN_PCT.")
